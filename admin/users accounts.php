...
<html lang="en">
  <head>
  	<title>Users Accounts | The Surgery</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <h2 class="mb-0">User's Accounts</h2>
		<p>Below are the the user's accounts list.
		</p>
    <?php
    ...
    if(mysqli_num_rows($res) > 0){
      ...
      while($row = mysqli_fetch_assoc($res)){
        ...
        <td><a href='#!'>".$row['u_email']."</a></td>
        <td>".$row['u_fullnames']."</td>
      ...
      echo"<h5>No user accounts found...</h5>";
    }
    ?>
      </div>
		</div>
