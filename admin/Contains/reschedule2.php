...
$ScheduleDate = mysqli_real_escape_string($conn,$_POST['ScheduleDate2']);
$ScheduleTime = mysqli_real_escape_string($conn,$_POST['ScheduleTime2']);
$bookingID = mysqli_real_escape_string($conn,$_POST['bookingID2']);
$output = "";
...
if($date <= $currentDate){
    ...
    if(mysqli_num_rows($checkRes) > 0){
        ...
        <i>----------<br/>
             ...
             <br>
            Dear: client<br/><br/>
            This email is to notify you that your booking <b>#$bookingID</b> has been scheduled to <b>$ScheduleDate, $ScheduleTime</b>. <i>NO REFUNDS ARE ALLOWED</i>.
            <br/><br/>
            Regards<br/>
