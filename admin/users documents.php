...
<html lang="en">
  <head>
  	<title>Users Documents | The Surgery</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    if(mysqli_num_rows($res) > 0){
      ...
      while($row = mysqli_fetch_assoc($res)){
        echo"
        <tr>
        <td><a href='more documents.php?more=".$row['doc_email']."'>".$row['doc_email']."</td>
        </tr>
        ";
      }
      echo"</tbody>
